...
#define HALL_EFFECT  GPIO_NUM_33

// WiFi credentialsfile:///run/media/firmware/Shreyas_Work/INTERNET OF THINGS/Raspduino_IoT_Sensor_Board/1. SAMPLE_CODES/SAMPLE_CODES/RASPBERRY PI/TESTED_OK_CODE_RASPBERRY_PI_JULLY22/keypad.py
...
void loop()
{
  ...
  doc["HALL_EFFECT"] = digitalRead(HALL_EFFECT);
