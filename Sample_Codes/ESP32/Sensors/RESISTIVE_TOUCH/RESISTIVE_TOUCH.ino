...
#define RESISTIVE_TOUCH  GPIO_NUM_33
...
#define TOKEN "bdThfGxgIYh7TmSuLrM8" // From ThingsBoard device dashboard
...
void loop()
{
  ...
  doc["RESISTIVE_TOUCH"] = digitalRead(RESISTIVE_TOUCH);
